...
const PolitiqueConf = () => {
    return (
        <div>
            <Header/>
            <h1 style={{textAlign:'center', marginTop:'20px'}}>Politique de confidentialité</h1>
...
Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à contact@laveilleusecoranique.com.
...
Si vous souhaitez: accéder à, corriger, modifier ou supprimer toute information personnelle que nous avons à votre sujet, déposer une plainte, ou si vous souhaitez simplement avoir plus d’informations, contactez notre agent responsable des normes de confidentialité à : contact@laveilleusecoranique.com.
<br/><br/><br/><br/><br/><br/>
</div>
        </div>
    )
