...
const Conditions = () => {
    return (
        <div>
            <Header/>
            <h1 style={{textAlign:'center', marginTop:'20px'}}>Conditions générales d'utilisations et de ventes</h1>
                <div style={{paddingLeft:'100px', paddingRight:'100px'}}>
                   
            Ce site web est exploité par LaVeilleuseCoranique.com. Sur ce site, les termes "nous", "notre" et "nos" font référence à  LaVeilleuseCoranique.com. LaVeilleuseCoranique.com propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.<br/><br/>
...
Toute infraction ou violation des présentes Conditions Générales de Vente et d’Utilisation entraînera la résiliation immédiate de vos Services.<br/><br/>




ARTICLE 2 – CONDITIONS GÉNÉRALES<br/><br/>
...
Les titres utilisés dans cet accord sont inclus pour votre commodité, et ne vont ni limiter ni affecter ces Conditions.<br/><br/>




ARTICLE 3 – EXACTITUDE, EXHAUSTIVITÉ ET ACTUALITÉ DES INFORMATIONS<br/><br/>
...
4.2 Les détails et zones de livraison<br/><br/>

 

La zone de livraison couvre la zone géographique de la France métropolitaine, Belgique et Luxembourg.

 

Les produits achetés seront livrés à l'adresse postale indiquée lors de la saisie de la commande.

La responsabilité de LaVeilleuseCoranique ne saurait donc en aucun cas être engagée à quelque titre que ce soit lorsque le retard est imputable au Client, c'est-à-dire soit en cas d'absence du destinataire lors de la livraison du Produit soit en cas d'erreur de saisie, de la part du Client, lors de la passation de la commande.

 

Toutefois, en cas de retard manifeste, LaVeilleuseCoranique se propose de mettre en œuvre toute action utile afin de contrôler, puis de régler tout dysfonctionnement du service de transport qui lui serait imputable.<br/><br/>

  

4.3 Modes de livraison<br/><br/>

La livraison des commandes s'effectuera au choix du Client : par Colissimo suivi ou en livraison en relais colis par le biais du réseau Mondial Relay 

 

Livraison Colissimo
Si vous choisissez le mode de livraison par Colissimo, vous serez alors livré directement à l’adresse indiquée au moment où vous avez préalablement effectué l’achat. Si vous n’êtes pas présent au moment de la livraison, le facteur vous déposera un avis de passage dans votre boîte au lettre. Vous devrez ensuite aller récupérer directement votre colis à la Poste.

 

Livraison en Mondial Relay
Si vous choisissez le mode de livraison par le biais du réseau Mondial Relay, nous aurons alors le choix parmi l’un des 4300 points relais situés en France Métropolitaine.

Ce mode de livraison vous propose d’être livré dans l’un des 4300 points relais du réseau Mondial Relay situés en France Métropolitaine.

 

En choisissant le mode de livraison en relais, le Client déclare avoir pris connaissance et adhéré sans réserve aux conditions générales de vente de Mondial Relay. Il est ainsi indiqué dans les conditions générales de ventes de Mondial Relay que  le destinataire sera averti de l’arrivée de son colis par e-mail et/ou SMS, en fonction des informations enregistrées par celui-ci. En cas d'indisponibilité du point relais préalablement choisi par le client, Mondial Relay procédera à un transfert vers le point Relais disponible le plus proche. Le commerçant du Point Mondial Relay tient votre colis à votre disposition durant un minimum de 7 jours calendaires, ce délai pouvant aller jusqu’à 14 jours calendaires, selon les contraintes de l’activité et des services choisis. Les colis qui n’auront pas été récupérés à l'issue de cette période seront retournés à l’expéditeur via le Point Relais de dépose. 

 

Le colis est remis au destinataire contre la présentation d’une pièce d’identité et contre signature numérisée sur le terminal du Point Relais® ou sur un bordereau de livraison. Dans le cas d'une signature sur un terminal électronique, celle-ci, ainsi que la reproduction, font preuve de la livraison du colis et les parties reconnaissent à cette signature une valeur juridique identique à celle d'une signature traditionnelle sur papier.

 

Les colis qui n’auront pas été récupérés par le destinataire à l'issue de cette période seront retournés à l’expéditeur via le Point Relais® de dépose. A l’issue de ce délai, le colis sera réexpédié par le Point Relais® de dépose, ainsi la récupération du colis est à la charge du Client qui devra s'acquitter des frais réels de réexpédition. 

 

En cas de retard de livraison, la responsabilité de LaVeilleuseCoranique ne pourra être engagée si ce retard est dû à un cas de force majeure ou du fait du tiers chargé du transport (raisons climatiques, jours d'interdiction de circuler...). <br/><br/>
...
Les colis sont en règle générale expédiés sous 24 heures ouvrables après la validation de la commande à l'exception des produits personnalisés dont le temps de préparation entraîne un délai supplémentaire, lequel pouvant varier en fonction du volume de commandes. 

 

Selon le mode de livraison sélectionné par le Client, les délais de livraisons varient :

        Colissimo : Deux à trois jours (ouvrables) pour la France métropolitaine
        Mondial Relay : Le délai moyen de livraison en relais est estimé de 4-5 jours ouvrés.
 

Les délais de livraison indiqués ci-dessus sont ceux généralement constatés. Le délai de livraison peut être rallongé de deux jours en période de soldes ou de toute autre opération promotionnelle.

Par ailleurs, LaVeilleuseCoranique informe ses Clients que ces délais de livraison ne comprennent ni dimanches, ni les jours fériés.<br/><br/>

 

ARTICLE 5 – MODIFICATIONS APPORTÉES AU SERVICE ET AUX PRIX<br/><br/>
...
ARTICLE 6 – PRODUITS OU SERVICES (le cas échéant)<br/><br/>
...
ARTICLE 7 – EXACTITUDE DE LA FACTURATION ET DES INFORMATIONS DE COMPTE<br/><br/>
...
ARTICLE 8 – OUTILS FACULTATIFS<br/><br/>

 

Nous pourrions vous fournir l’accès à des outils de tierces parties sur lesquels nous exerçons ni suivi, ni contrôle, ni influence.
...
ARTICLE 10 – COMMENTAIRES, SUGGESTIONS ET AUTRES PROPOSITIONS D’UTILISATEURS<br/><br/>
...
ARTICLE 11 – RENSEIGNEMENTS PERSONNELS<br/><br/>
...
ARTICLE 12 – ERREURS, INEXACTITUDES ET OMISSIONS<br/><br/>
...
ARTICLE 13 – UTILISATIONS INTERDITES<br/><br/>
...
ARTICLE 14 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ<br/><br/>
...
ARTICLE 15 – INDEMNISATION<br/><br/>
...
ARTICLE 16 – DISSOCIABILITÉ<br/><br/>
...
ARTICLE 18 – INTÉGRALITÉ DE L’ACCORD<br/><br/>
...
ARTICLE 19 – LOI APPLICABLE<br/><br/>
...
ARTICLE 20 – MODIFICATIONS APPORTÉES AUX CONDITIONS GÉNÉRALES DE VENTE ET D’UTILISATION
<br/><br/>
...
Les questions concernant les Conditions Générales de Vente et d’Utilisation devraient nous être envoyées à contact@laveilleusecoranique.com.
</div>
        </div>
    )
}
